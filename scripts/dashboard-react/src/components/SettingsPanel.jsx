      ...
      <div className="flex items-center justify-between mb-3">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            AI-suggested text corrections generated by "Polish Flagged" in the transcript editor. They
            persist after polishing until you approve or reject them here — approved corrections update
            the saved transcript.{corrections.length > 0 && ` ${corrections.length} pending${multiCount > 0 ? `, ${multiCount} with multi-speaker notes` : ''}.`}
          </p>
        </div>
